...
function init() {
  ...
  scene.add(camera);
  camera.position.z = 1173;
  camera.position.x = 759;
  camera.position.y = 193;
  ...
  var molecule = gui.add(text, 'molecule', ['Glycine', 'Leucine', 'Alanine', 'Valine']);
